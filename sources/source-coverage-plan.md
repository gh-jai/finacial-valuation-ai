...
| `SRC-DAMODARAN-INVESTMENT-FABLES` | Primary evidence framework | strategy testing, empirical evidence, base rates, screening failure modes | Post-M6 | Historical tests require time-period and sample-context disclosure |
...
| `SRC-BAID-JOYS-COMPOUNDING-ZH-2024` | Primary judgment, translated edition | mental models, temperament, checklists, decision journals, margin of safety, portfolio sizing, compounding | Post-M6 | Distinguish cited ideas from the many thinkers discussed in the book |
